...
const STANDUP_KEYWORDS: Record<string, string[]> = {
  ...
  'dashboard': ['ui', 'frontend', 'interface', 'admin', 'แดชบอร์ด', 'แดร์บอร์ด', 'แด๊ดบอล', 'แบตบอล', 'แดทบอร์ด', 'แดสบอร์ด', 'เดชบอร์ด'],
  'แดชบอร์ด': ['dashboard', 'ui', 'frontend', 'interface', 'admin'],
  'แดร์บอร์ด': ['dashboard', 'ui', 'frontend', 'interface', 'admin'], 
  'แด๊ดบอล': ['dashboard', 'ui', 'frontend', 'interface', 'admin'],
  'แบตบอล': ['dashboard', 'ui', 'frontend', 'interface', 'admin'],
  'แดทบอร์ด': ['dashboard', 'ui', 'frontend', 'interface', 'admin'],
  'แดสบอร์ด': ['dashboard', 'ui', 'frontend', 'interface', 'admin'],
  'เดชบอร์ด': ['dashboard', 'ui', 'frontend', 'interface', 'admin'],
  'ui': ['frontend', 'interface', 'component', 'design'],
  'interface': ['ui', 'frontend', 'design', 'component'],
  'component': ['ui', 'frontend', 'react', 'vue'],
  
  // Testing
  'test': ['testing', 'unit', 'integration', 'qa', 'spec', 'เทส', 'เทสต์', 'เทสติ้ง'],
  'testing': ['test', 'unit', 'integration', 'qa', 'เทส', 'เทสต์', 'เทสติ้ง'],
  'เทส': ['test', 'testing', 'unit', 'integration', 'qa'],
  'เทสต์': ['test', 'testing', 'unit', 'integration', 'qa'],
  'เทสติ้ง': ['testing', 'test', 'unit', 'integration', 'qa'],
  'unit': ['test', 'testing', 'spec', 'jest', 'ยูนิต'],
  'ยูนิต': ['unit', 'test', 'testing', 'unittest'],
  'integration': ['test', 'testing', 'e2e'],
  
  // Development & General
  'feature': ['functionality', 'implementation', 'development', 'ฟีเจอร์', 'ฟีเจอ'],
  'ฟีเจอร์': ['feature', 'functionality', 'implementation', 'development'],
  'ฟีเจอ': ['feature', 'functionality', 'implementation', 'development'],
  'bug': ['fix', 'issue', 'error', 'debug', 'problem', 'บัค', 'บัก', 'ปัญหา'],
  'บัค': ['bug', 'fix', 'issue', 'error', 'debug', 'ปัญหา'],
  'บัก': ['bug', 'fix', 'issue', 'error', 'debug', 'ปัญหา'],
  'ปัญหา': ['bug', 'issue', 'problem', 'error', 'fix'],
  'fix': ['bug', 'issue', 'error', 'debug', 'repair', 'แก้ไข'],
  'แก้ไข': ['fix', 'bug', 'issue', 'repair', 'debug'],
